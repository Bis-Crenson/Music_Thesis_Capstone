...
{
    public RectangularPrismGeometry()
    {
        this(1,1,1);
    }

    public RectangularPrismGeometry(double width, double height, double depth)
    {
        // corners of a cube
        Vector P0 = new Vector(-width/2, -height/12, 2*-depth);
        Vector P1 = new Vector( width/2, -height/12, 2*-depth);
        Vector P2 = new Vector(-width/2,  height/12, 2*-depth);
        Vector P3 = new Vector( width/2,  height/12, 2*-depth);
        Vector P4 = new Vector(-width/2, -height/12, 2* depth);
        Vector P5 = new Vector( width/2, -height/12, 2* depth);
        Vector P6 = new Vector(-width/2,  height/12, 2* depth);
        Vector P7 = new Vector( width/2,  height/12, 2* depth);
